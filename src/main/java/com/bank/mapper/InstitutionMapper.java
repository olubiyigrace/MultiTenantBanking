...
public class InstitutionMapper {
    ...
    public Institution toEntity(final RegisterInstitutionRequest institutionRequest){
        return Institution.builder()
                .companyName(institutionRequest.getCompanyName())
                .companyEmail(institutionRequest.getCompanyEmail())
                .companyPhone(institutionRequest.getCompanyPhone())
                .companyRcNumber(institutionRequest.getCompanyRcNumber())
    ...
    public InstitutionResponse toResponse(final Institution institution){
        return InstitutionResponse.builder()
                ...
                .name(institution.getCompanyName())
                .email(institution.getCompanyEmail())
                .phone(institution.getCompanyPhone())
                .rcNumber(institution.getCompanyRcNumber())
