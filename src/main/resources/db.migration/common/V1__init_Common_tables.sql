...
(
 ...
 constraint institutions_base_currency_check
            check ((base_currency)::text = ANY
        (ARRAY [('NGN':: character varying)::text,
        ('USD':: character varying)::text,
        ('CAD':: character varying)::text,
        ('GHS':: character varying)::text,
        ('EUR':: character varying)::text,
        ('GBP':: character varying)::text,
        ('AED':: character varying)::text,
        ('AUD':: character varying)::text])
) ,
...
(
    ...
    deposit_slip_number        varchar(255),
